...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Chào mừng đến với BinaryLLM, Binary Digital Employees is an open-source AI tool by Mintplex Labs that turns anything into a trained chatbot you can query and chat with. Binary Digital Employees is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of BinaryLLM",
    },
    pfp: {
  ...
  api: {
    title: "Khóa API",
    description:
      "API keys allow the holder to programmatically access and manage this Binary Digital Employees instance.",
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else Binary Digital Employees will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall Binary Digital Employees when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which Binary Digital Employees can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when using BinaryLLM's native embedding engine.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your Binary Digital Employees instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect your Binary Digital Employees instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and Binary Digital Employees handle your data.",
    llm: "LLM Selection",
