        ...
        <div className="w-fit">
          ...
          <div className="flex items-center gap-x-4">
            <input
              ...
              placeholder="Binary Digital Employees | Your personal Binary Digital Employees  trained on anything"
              autoComplete="off"
              onChange={(e) => {
                setSettings((prev) => {
              ...
              value={
                settings.title ??
                "Binary Digital Employees  | Your personal Binary Digital Employees trained on anything"
              }
            />
          </div>
        </div>
