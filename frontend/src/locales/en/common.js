const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Binary Digital Employees can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome toBinaryLLM",
      description: "Help us makeBinary Digital Employees built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you useBinary Digital Employees for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear aboutBinaryLLM?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started withBinaryLLM.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Welcome to Binary Digital Employees, Binary Digital Employees is a all-in-one modular platform to create Digital Employees for your operation.",
    part2:
      "Binary Digital Employees is the easiest way to put powerful AI products like OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB, and other services together in a neat package with no fuss to increase your productivity by 100x.",
    part3:
      "Binary Digital Employees can run totally locally on your machine with little overhead you wont even notice it's there! No GPU needed. Cloud and on-premises installation is available as well.\nThe AI tooling ecosystem gets more powerful everyday.Binary Digital Employees makes it easy to use.",
  ...
  appearance: {
    ...
    message: {
      ...
      user: "user",
      message: "message",
      assistant: "Binary Digital Employees Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage thisBinary Digital Employees instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or elseBinary Digital Employees will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stallBinary Digital Employees when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format whichBinary Digital Employees can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when usingBinaryLLM's native embedding engine.",
    },
  },
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how yourBinary Digital Employees instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect yourBinary Digital Employees instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers andBinary Digital Employees handle your data.",
    llm: "LLM Selection",
